      ...
      if (saved) {
          try {
              ...
              if (parsed.gameState && parsed.gameState.stats) {
                  ...
                  if (!gs.skills['Attack']) gs.skills['Attack'] = { name: 'Attack', level: 1, xp: 0 };
                  if (!gs.skills['Strength']) gs.skills['Strength'] = { name: 'Strength', level: 1, xp: 0 };
                  if (!gs.skills['Defence']) gs.skills['Defence'] = { name: 'Defence', level: 1, xp: 0 };
                  if (!gs.skills['Constitution']) gs.skills['Constitution'] = { name: 'Constitution', level: 10, xp: 1100 };
