...
export const ASSETS = {
  ...
  `),
  LAMP: createAsset(`
    <rect x="7" y="8" width="2" height="8" fill="#44403c"/>
    <rect x="6" y="2" width="4" height="6" fill="#fbbf24"/>
    <rect x="5" y="2" width="6" height="1" fill="#44403c"/>
    <rect x="6" y="2" width="4" height="6" fill="none" stroke="#ca8a04" stroke-width="1"/>
  `),
  FOUNTAIN: createAsset(`
    <circle cx="8" cy="8" r="6" fill="#3b82f6" stroke="#57534e" stroke-width="2"/>
    <circle cx="8" cy="8" r="3" fill="#93c5fd" class="animate-pulse"/>
  ...
  CHICKEN: createAsset(`
    ...
    <path d="M10,5 L11,4 L12,5" stroke="#ef4444" fill="none"/>
    <path d="M6,13 L5,15 M8,13 L9,15" stroke="#f59e0b"/>
  `),
  ...
  HAT_SANTA: createAsset(`<path d="M2,12 L14,12 L8,2 Z" fill="#dc2626"/><circle cx="8" cy="2" r="1.5" fill="#fff"/><rect x="2" y="12" width="12" height="2" fill="#fff"/>`),
  HAT_HOOD: createAsset(`<path d="M2,14 L2,4 Q8,-4 14,4 L14,14" fill="#4b5563"/>`),
};
